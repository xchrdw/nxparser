...
public class DateTimeLiteral extends Literal {
	...
	public DateTimeLiteral(String date) throws ParseException, NumberFormatException {
		super(date, DATETIME);
	...
	public int compareTo(DateTimeLiteral dtl){
			...
			if (t.nextToken().equals("T")) {
				...
				if (t.nextToken().equals(":")) {
					...
					if (token.equals("Z")) {
						...
						offset = sign * Integer.parseInt(t.nextToken()) * 1000 * 3600;
					}
